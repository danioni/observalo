...
const A = 5.84;  // slope in log-log space
...
// These create even spacing in log space from ~0.4x to ~15x of base
const BAND_MULTIPLIERS = [0.4, 0.55, 0.75, 1.0, 1.4, 1.95, 2.75, 3.9, 5.5, 8.0];
